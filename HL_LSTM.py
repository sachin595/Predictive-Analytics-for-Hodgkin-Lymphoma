...
model = load('HLmodel.joblib')
scalerX = load('HLscalerX.joblib')
scalerY = load('HLscalerY.joblib')
scalerT = load('HLscalerT.joblib')
...
st.title('Predictive Analytics for Hodgkin Lymphoma')
